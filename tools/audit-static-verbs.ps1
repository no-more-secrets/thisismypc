...
.SYNOPSIS
    ...
    Produces a markdown report of every verb, its execution type, and its scope.

.DESCRIPTION
    Scans the 10 registry scope paths the shell reads static verbs from.
...
**Purpose:** Ground truth for static verb enumeration in the context menu scanner
**Generated by:** ``tools/audit-static-verbs.ps1``
...
# Key findings
[void]$tail.AppendLine("## Key Findings")
[void]$tail.AppendLine("")
...
# Cross-reference vs deep-research SUMMARY.md
