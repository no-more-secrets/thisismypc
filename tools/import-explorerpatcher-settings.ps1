...
$document = [ordered]@{
    _note     = 'Registry values under HKCU\Software\ExplorerPatcher that ExplorerPatcher reads: key, value, type, default, options, conditions. Generated by tools/import-explorerpatcher-settings.ps1 against the pinned release; the pin moves only after a deliberate check.'
    _version  = $Version
