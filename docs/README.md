...
| [hardware-detection.md](hardware-detection.md) | Shared native inventory contract, Home integration, and hardware evidence limits. |
...
| [lighting-controllers.md](lighting-controllers.md) | The bundled lighting engine: OpenRGB's device core built from the pinned submodule without Qt, the host protocol, the build, and how to bump the pin. |
...
| [research/configured-policy-coverage.md](research/configured-policy-coverage.md) | Sanitized mapping of 148 exported policies to current controls, gaps, and unresolved scope questions. |
