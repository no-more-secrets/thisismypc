...
public partial class SidebarItemViewModel : ViewModelBase
{
    ...
    private static readonly FrozenDictionary<string, string> IconPaths = new Dictionary<string, string>
    {
        ...
        // Display: monitor outline with stand
        ["display"] = "M4 3C2.9 3 2 3.9 2 5V15C2 16.1 2.9 17 4 17H10V19H8C7.45 19 7 19.45 7 20C7 20.55 7.45 21 8 21H16C16.55 21 17 20.55 17 20C17 19.45 16.55 19 16 19H14V17H20C21.1 17 22 16.1 22 15V5C22 3.9 21.1 3 20 3H4ZM4 5H20V15H4V5Z",
