// Derived from LibreHardwareMonitor, MPL-2.0. See README.md and LICENSE.
// Local changes: read-only subset; verified preloaded System32 image only.
#nullable disable
using System;
...
internal static class NvApi
{
    ...
    public static void Initialize()
    {
        ...
        if (nvApiInitialize is not null && nvApiInitialize() == NvStatus.OK)
        {
    ...
    // Loading and publisher validation belong to the adapter. Never search ambient paths.
    public static bool DllExists() => GetModuleHandleW("nvapi64.dll") != IntPtr.Zero;
