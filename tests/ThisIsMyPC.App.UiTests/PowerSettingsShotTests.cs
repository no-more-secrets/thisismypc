...
public class PowerSettingsShotTests
{
    ...
    private static IReadOnlyList<PowerSettingInfo> SampleSettings() =>
    [
    ...
    public async Task Settings_OpenAsOneTabPerGroup()
    {
        ...
        var viewModel = new PowerViewModel(ScanData(), changes, powerService: new UiFakePowerService(SampleSettings()));
